                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="card card-primary">
                            ...
                            <form role="form" action="{{ route('admin.xml.update',$xml->id) }}" method="post"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="restaurant_id" class="form-control">
                                                    ...
                                                    @foreach($restaurants as $restaurant)
                                                        ...
                                                        <option
                                                            value="{{ $restaurant->id }}"
                                                            @if($xml->restaurant_id == $restaurant->id) selected="" @endif>{{ $restaurant->name }}</option>
                                                    @endforeach
                                                </select>
                                                @error('restaurant_id')
                                                <p class="text-red mt-1">{{ $message }}</p>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="price" value="{{ $xml->price }}"
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" class="form-control"
                                                          ...
                                                          rows="3">{{$xml->description}}</textarea>
