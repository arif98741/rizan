    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Team Member Updating Form</h1>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="card card-primary">
                            ...
                            <form role="form" action="{{ route('admin.team_member.update',$team_member->id) }}" method="post"
                                    ...
                                    <div class="col-md-6">
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" value="{{ $team_member->name }}"
                                                       class="form-control"
                                                       id="name"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="designation" value="{{ $team_member->description }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="twitter" value="{{ $team_member->twitter }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="facebook" value="{{ $team_member->facebook }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="instagram" value="{{ $team_member->instagram }}"
