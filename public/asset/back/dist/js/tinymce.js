                            ...
                            if (s)
                                for (r = 0, o = (s = ci(s, "|")).length; r < o; r++)
                                    if ((i = x.exec(s[r]))) {
                                        ...
                                        g &&
                                        ("=" === g && ((a.attributesDefault = a.attributesDefault || []), a.attributesDefault.push({
                                            name: l,
                                            value: b
                                        }), (u.defaultValue = b)),
                                        ":" === g && ((a.attributesForced = a.attributesForced || []), a.attributesForced.push({
                                            name: l,
                                            value: b
                                        }), (u.forcedValue = b)),
        ...
        return (
            u.on("init", function () {
                ...
                u.on("KeyUp", function (e) {
                    ...
                    r && o.typing && !1 === ny(ey(u), l[0]) && (!1 === u.isDirty() && (d(!0), u.fire("change", {
                        level: l[0],
                        lastLevel: null
        ...
        Db = function (r, a) {
            ...
            var R = function (e) {
                ...
                B = function (e) {
                    ...
                    (t = A.scrollWidth - x) + (n = A.scrollHeight - w) != 0 && N.setStyles(c, {
                        left: r - t,
                        top: o - n
                    }),
                    i || (Tp(a, u, h, v), (i = !0));
        ...
        Bw = function (t) {
            ...
            if (Se.Event.domLoaded) {
                if (t.getElement() && fe.contentEditable) {
                    ...
                    o &&
                    ((t.formElement = o),
                    e.hidden_input && !/TEXTAREA|INPUT/i.test(t.getElement().nodeName) && (Rw.insertAfter(Rw.create("input", {
                        type: "hidden",
                        name: n
                    }), n), (t.hasHiddenInput = !0)),
                            ...
                            : ((t = u),
                                ...
                                0 === (r = s).length || /^\s+$/.test(r)
                                    ? ((a = '<br data-mce-bogus="1">'),
                                        ...
                                        qw(t, r),
                                        t.fire("SetContent", o))
                                    : ("raw" !== o.format && (r = al({validate: t.validate}, t.schema).serialize(t.parser.parse(r, {
                                        isRootContent: !0,
                                        insert: !0
                                    }))),
            ...
            execCallback: function (e) {
                ...
                if (o)
                    return (
                        ...
                        "string" == typeof o && ((r = (r = o.replace(/\.\w+$/, "")) ? Zw(r) : 0), (o = Zw(o)), (this.callbackLookup = this.callbackLookup || {}), (this.callbackLookup[e] = {
                            func: o,
                            scope: r
                        })),
